...
from api.OkcoinFutureAPI import OKCoinFuture

#初始化apikey，secretkey,url
apikey = '5fb53fe9-3526-4929-b706-cf2448f65604'
secretkey = '7A9C0537A15F3D75B2566AE0B5F7F8B6'
okcoinRESTURL = 'https://www.okcoin.cn'   #请求注意：国内账号需要 修改为 www.okcoin.cn  
...
print (u' 现货历史交易信息 ')
print (okcoinSpot.trades('ltc_cny'))
